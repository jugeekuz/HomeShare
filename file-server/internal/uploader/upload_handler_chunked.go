...
func ParseFormChunked(w http.ResponseWriter, r *http.Request) (ChunkMeta, Chunk, error) {
	const MAX_MBYTES = 5
...
func UploadHandlerChunked(w http.ResponseWriter, r *http.Request, jm *job.JobManager) {
	...
	meta, chunk, err := ParseFormChunked(w, r)
	if err != nil {
